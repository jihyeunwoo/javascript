...
// 1. 산술연산자 : +, -, *, /, %
// 1-1. 문자연결 연산자: +(덧셈이 아닌 문자열끼리 어어서 쓰는 연산자)
...
// 3. 증감 연산자 : ++, --
// 위치에 따른 결과가 달라짐 : A = B++ vs A = ++B 와 다른결과
*/
/*
let a = 10;
let b = 20;
...
console.log(bool1 && bool2);    // flase(둘다 true여야 최종 true : AND 연산)
console.log(bool1 || bool2);    // true (둘 중 하나만라도 true면 최종 true : OR 연산)
console.log(!bool1);
*/
